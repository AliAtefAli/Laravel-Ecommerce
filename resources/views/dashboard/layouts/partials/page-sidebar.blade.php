...
<div class="page-sidebar">
    <div class="main-header-left d-none d-lg-block">
        <div class="logo-wrapper"><a href="index.html"><img class="blur-up lazyloaded"
                                                            src="{{ asset('assets/images/dashboard/multikart-logo.png') }}"
                                                            alt=""></a></div>
    </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="sidebar-header" href="{{route('order.index')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <path d="M16 4h2a2
                                                                2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0
                                                                0 1 2-2h2"></path>
            ...
            <li><a class="sidebar-header" href="">
                    ...
                    <span>Settings</span><i class="fa fa-angle-right pull-right"></i></a>
                <ul class="sidebar-submenu">
                    <li><a href="profile.html"><i class="fa fa-circle"></i>Update Profile</a></li>
                </ul>
            </li>
