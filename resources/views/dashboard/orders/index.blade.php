                    ...
                    <div class="card-body order-datatable">
                        <table class="display" id="basic-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <img src="{{ asset('assets/images/electronics/product/13.jpg') }}" alt="" class="img-fluid img-30 mr-2 blur-up lazyloaded">
                                        <img src="{{ asset('assets/images/electronics/product/16.jpg') }}" alt="" class="img-fluid img-30 blur-up lazyloaded">
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="{{ asset('assets/images/electronics/product/19.jpg') }}" alt="" class="img-fluid img-30 mr-2 blur-up lazyloaded">
                                        <img src="{{ asset('assets/images/electronics/product/20.jpg') }}" alt="" class="img-fluid img-30 mr-2 blur-up lazyloaded">
                                        <img src="{{ asset('assets/images/electronics/product/23.jpg') }}" alt="" class="img-fluid img-30 blur-up lazyloaded">
                                    </div>
                                </td>
                                <td><span class="badge badge-success">Paid</span></td>
                                <td>Visa</td>
