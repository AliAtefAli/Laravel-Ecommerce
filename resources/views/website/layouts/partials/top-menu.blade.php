    ...
    <div>
        <div class="icon-nav">
            <ul>
                ...
                <li id="cart-dropdown" class="onhover-div mobile-cart">
                    <div><img src="../assets/images/icon/shopping-cart.png"
                              class="img-fluid blur-up lazyload" alt=""> <i
                            class="ti-shopping-cart"></i>
                        <span class="badge badge-pill badge-primary pull-right notification-badge">{{ Cart::count() }}</span>
                    </div>
                    ...
                    <ul class="show-div shopping-cart">
                            ...
                            <li>
                                <div class="media">
                                    <a href="#"><img alt="" class="mr-3"
                                                     src="{{ asset('assets/images/products/' . $cart->model->images()->first()['path'] ) }}"></a>
                                    <div class="media-body">
                                        <a href="#">
                                            <h4>{{ $cart->name }}</h4>
                                        </a>
                                        <h4><span>{{ $cart->qty }} x $ {{ $cart->price }}</span></h4>
                                    </div>
                                </div>
                        ...
                        <li>
                            <div class="buttons">
                                ...
                                <a href="{{ route('checkout.index') }}" class="checkout">checkout</a></div>
                        </li>
                    </ul>
                </li>
            </ul>
